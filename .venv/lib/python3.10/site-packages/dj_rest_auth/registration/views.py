...
class RegisterView(CreateAPIView):
    ...
    def create(self, request, *args, **kwargs):
        ...
        groupSelected = all_data['group']
        schoolDistrict = all_data['school_district']
        schoolSite = all_data['school_site']
        # print('group: ', groupSelected)

        if data:
            # added code
            g = Group.objects.get(name=groupSelected)
            g.user_set.add(user)
            # added code -- it works!
            response = Response(
                data,
...
class VerifyEmailView(APIView, ConfirmEmailView):
    ...
    def get(self, *args, **kwargs):
        ...
        object_email = str(self_object.email_address)
        print(object_email)
        # print(object_email)
        return Response({'email': object_email})
