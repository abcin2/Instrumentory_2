...
function AvailableInstruments() {
    ...
    const [availableInstrumentsForSearch, setAvailableInstrumentsForSearch] = useState([]);
    ...
    useEffect(() => {
        async function fetchAvailableInstruments() {
            ...
            setAvailableInstrumentsForSearch(available_instruments);
    ...
    const instrumentChange = (e) => {
        ...
        let search_bar = document.getElementById('available-search-bar')
        search_bar.value = ''
        ...
        if (selected_type === 'None') {
            ...
            setAvailableInstruments(availableInstrumentsForFilter) // always full list
            setAvailableInstrumentsForSearch(availableInstrumentsForFilter)
        } else {
            ...
            setAvailableInstrumentsForSearch(filtered_instrument_list)
    ...
    const searchBarChange = (e) => {
        ...
        if (searchable_chars === '') {
            ...
            setAvailableInstruments(availableInstrumentsForSearch)
        } else {
            for (let inst of availableInstrumentsForSearch) {
        ...
        <div className="full-inventory">
            <div id="full-inventory-title-text">
                ...
                <div className="filter-choices">
                    <label>Status: </label>
                    <select className='status-filter' defaultValue={'Available'} onChange={statusChange}>
                    ...
                    <div className='search-bar'>
                        <input id='available-search-bar' type="text" placeholder='Start Typing...' onChange={searchBarChange} />
                    </div>
                </div>
            </div>
