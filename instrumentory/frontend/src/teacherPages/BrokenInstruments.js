...
function BrokenInstruments() {
    ...
    const fetchAllInstrumentsAfterDelete = async () => {
        ...
        setBrokenInstruments(instrument_data.instrument);
    }
    ...
    const showModal = (e) => {
        ...
        for (let i=0; i < allModals.length; i++) {
            ...
            if (brokenInstruments[i].id == (e.target.id)) {
    ...
    <div id="available-instruments-full-page">
        ...
        <div className="full-inventory">
            <div id="full-inventory-title-text">
                <div>
                    <h1>Broken Instruments</h1>
                </div>
                {/* This will need to be styled and adjusted more later */}
                <div className="filter-choices">
                    <label>Status: </label>
                    <select className='status-filter' defaultValue={'Broken'} onChange={statusChange}>
...
export default BrokenInstruments