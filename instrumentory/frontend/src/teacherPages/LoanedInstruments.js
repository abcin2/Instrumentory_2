...
function LoanedInstruments() {
    ...
    const [loanedInstrumentsForSearch, setLoanedInstrumentsForSearch] = useState([]);
    ...
    useEffect(() => {
        async function fetchLoanedInstruments() {
            ...
            setLoanedInstrumentsForSearch(loaned_instruments);
    ...
    const instrumentChange = (e) => {
        ...
        let search_bar = document.getElementById('loaned-search-bar')
        search_bar.value = ''
        ...
        if (selected_type === 'None') {
            ...
            setLoanedInstrumentsForSearch(loanedInstruments)
        } else {
            ...
            setLoanedInstrumentsForSearch(filtered_instrument_list)
    ...
    const searchBarChange = (e) => {
        ...
        if (searchable_chars === '') {
            ...
            setLoanedInstruments(loanedInstrumentsForSearch)
        } else {
            for (let inst of loanedInstrumentsForSearch) {
